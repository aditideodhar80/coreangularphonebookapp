...
namespace CoreAngularDemo.Web.Authentication.JwtBearer
{
    public class CoreAngularDemoJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public CoreAngularDemoJwtSecurityTokenHandler()
        {
