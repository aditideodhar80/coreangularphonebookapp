...
using CoreAngularDemo.Web.Authentication.JwtBearer;
using CoreAngularDemo.Web.Authentication.TwoFactor;
using CoreAngularDemo.Web.Chat.SignalR;
using CoreAngularDemo.Web.Configuration;

namespace CoreAngularDemo.Web
{
    [DependsOn(
        typeof(CoreAngularDemoApplicationModule),
        typeof(CoreAngularDemoEntityFrameworkCoreModule),
    ...
    public class CoreAngularDemoWebCoreModule : AbpModule
    {
        private readonly IHostingEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public CoreAngularDemoWebCoreModule(IHostingEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(CoreAngularDemoApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(CoreAngularDemoWebCoreModule).GetAssembly());
        }
        ...
        private void SetAppFolders()
        {
            ...
            {
                var currentAssemblyDirectoryPath = typeof(CoreAngularDemoWebCoreModule).GetAssembly().GetDirectoryPathOrNull();
