...
namespace CoreAngularDemo.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : CoreAngularDemoServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("CoreAngularDemo", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
