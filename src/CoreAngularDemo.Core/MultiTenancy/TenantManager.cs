...
using CoreAngularDemo.MultiTenancy.Demo;
...
namespace CoreAngularDemo.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(CoreAngularDemoConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
