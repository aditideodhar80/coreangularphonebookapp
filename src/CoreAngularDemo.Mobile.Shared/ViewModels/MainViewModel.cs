...
using MvvmHelpers;
using CoreAngularDemo.Authorization.Users.Profile;
using CoreAngularDemo.Authorization.Users.Profile.Dto;
using CoreAngularDemo.Commands;
using CoreAngularDemo.Core.Threading;
using CoreAngularDemo.Models.NavigationMenu;
using CoreAngularDemo.Services.Navigation;
...
using CoreAngularDemo.ApiClient;
using CoreAngularDemo.Controls;
using CoreAngularDemo.Dto;
using CoreAngularDemo.Extensions;
using CoreAngularDemo.Localization;
using CoreAngularDemo.UI;
using CoreAngularDemo.UI.Assets;
using CoreAngularDemo.Views;
using DependencyResolver = CoreAngularDemo.Core.Dependency.DependencyResolver;
...
namespace CoreAngularDemo.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "CoreAngularDemo";
