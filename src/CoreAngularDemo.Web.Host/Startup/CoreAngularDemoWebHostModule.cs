...
{
    [DependsOn(
        typeof(CoreAngularDemoWebCoreModule)
    )]
    public class CoreAngularDemoWebHostModule : AbpModule
    {
        private readonly IHostingEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public CoreAngularDemoWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(CoreAngularDemoWebHostModule).GetAssembly());
        }
