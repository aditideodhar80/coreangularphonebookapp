...
using CoreAngularDemo.Web.Common;
using PaulMiami.AspNetCore.Mvc.Recaptcha;
using Swashbuckle.AspNetCore.Swagger;
using CoreAngularDemo.Web.IdentityServer;
using CoreAngularDemo.Web.Swagger;
using Stripe;
...
namespace CoreAngularDemo.Web.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            if (WebConsts.SwaggerUiEnabled)
            {
                ...
                {
                    options.SwaggerDoc("v1", new Info { Title = "CoreAngularDemo API", Version = "v1" });
            ...
            return services.AddAbp<CoreAngularDemoWebHostModule>(options =>
            {
