...
using Abp.UI;
using CoreAngularDemo.Notifications.Dto;

namespace CoreAngularDemo.Notifications
{
    [AbpAuthorize]
    public class NotificationAppService : CoreAngularDemoAppServiceBase, INotificationAppService
    {
