...
using CoreAngularDemo.Authentication.TwoFactor.Google;
using CoreAngularDemo.Authorization.Users.Dto;
using CoreAngularDemo.Authorization.Users.Profile.Cache;
using CoreAngularDemo.Authorization.Users.Profile.Dto;
using CoreAngularDemo.Friendships;
using CoreAngularDemo.Gdpr;
using CoreAngularDemo.Identity;
using CoreAngularDemo.Net.Sms;
using CoreAngularDemo.Security;
using CoreAngularDemo.Storage;
using CoreAngularDemo.Timing;

namespace CoreAngularDemo.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : CoreAngularDemoAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("CoreAngularDemo",
        ...
        public async Task<UpdateGoogleAuthenticatorKeyOutput> UpdateGoogleAuthenticatorKey()
        {
            ...
            {
                QrCodeSetupImageUrl = _googleTwoFactorAuthenticateService.GenerateSetupCode("CoreAngularDemo",
                    user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300).QrCodeSetupImageUrl
            };
        }
