...
using CoreAngularDemo.Authorization.Roles.Dto;

namespace CoreAngularDemo.Authorization.Roles
{
    /// <summary>
    /// Application service that is used by 'role management' page.
    /// </summary>
    [AbpAuthorize(AppPermissions.Pages_Administration_Roles)]
    public class RoleAppService : CoreAngularDemoAppServiceBase, IRoleAppService
    {
