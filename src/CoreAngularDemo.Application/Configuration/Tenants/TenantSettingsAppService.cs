...
using CoreAngularDemo.Configuration.Tenants.Dto;
using CoreAngularDemo.Security;
using CoreAngularDemo.Storage;
using CoreAngularDemo.Timing;

namespace CoreAngularDemo.Configuration.Tenants
{
    ...
    public class TenantSettingsAppService : SettingsAppServiceBase, ITenantSettingsAppService
    {
        ...
        {
            if (_multiTenancyConfig.IsEnabled && !CoreAngularDemoConsts.AllowTenantsToChangeEmailSettings)
            {
                return;
            }
