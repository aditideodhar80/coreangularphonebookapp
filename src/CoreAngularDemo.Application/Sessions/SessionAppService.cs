...
using CoreAngularDemo.UiCustomization;

namespace CoreAngularDemo.Sessions
{
    public class SessionAppService : CoreAngularDemoAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = CoreAngularDemoConsts.Currency,
                    CurrencySign = CoreAngularDemoConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = CoreAngularDemoConsts.AllowTenantsToChangeEmailSettings
                }
            };
