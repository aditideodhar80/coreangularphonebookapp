...
using CoreAngularDemo.Tenants.Dashboard.Dto;

namespace CoreAngularDemo.Tenants.Dashboard
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Tenant_Dashboard)]
    public class TenantDashboardAppService : CoreAngularDemoAppServiceBase, ITenantDashboardAppService
    {
