...
using CoreAngularDemo.Migrations.Seed.Host;
...
namespace CoreAngularDemo.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : CoreAngularDemoAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<CoreAngularDemoDbContext> _migrator;
        ...
        private string GetConnectionString()
        {
            ...
            return connectionStrings.Property(CoreAngularDemoConsts.ConnectionStringName).Value.ToString();
        }
