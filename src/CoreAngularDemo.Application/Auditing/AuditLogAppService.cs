...
using CoreAngularDemo.Auditing.Exporting;
...
using EntityHistoryHelper = CoreAngularDemo.EntityHistory.EntityHistoryHelper;

namespace CoreAngularDemo.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : CoreAngularDemoAppServiceBase, IAuditLogAppService
    {
