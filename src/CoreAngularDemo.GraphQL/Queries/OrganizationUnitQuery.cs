...
using CoreAngularDemo.Core.Base;
using CoreAngularDemo.Core.Extensions;
using CoreAngularDemo.Dto;
using CoreAngularDemo.Types;

namespace CoreAngularDemo.Queries
{
    public class OrganizationUnitQuery : CoreAngularDemoQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
