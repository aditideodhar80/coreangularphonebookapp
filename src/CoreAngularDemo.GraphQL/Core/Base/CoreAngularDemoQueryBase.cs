...
namespace CoreAngularDemo.Core.Base
{
    public abstract class CoreAngularDemoQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected CoreAngularDemoQueryBase(string fieldName,
