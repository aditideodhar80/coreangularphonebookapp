...
using CoreAngularDemo.Web.Public.Startup;
using CoreAngularDemo.Web.Session;

namespace CoreAngularDemo.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : CoreAngularDemoViewComponent
    {
